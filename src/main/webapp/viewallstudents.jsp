...
<%@page import="com.klef.ep.models.Student"%><%@page import="java.util.*"%>
 <%
...
StudentService studentService = (StudentService) context1.lookup("java:global/SFISYSTEM/StudentServiceImpl!com.klef.ep.services.StudentService");

List<Student> ftylist = studentService.viewAllStudents();

for(Student fty : ftylist)
{
	  %>
            <tbody>
                ...
                <tr>
                    <td><%=fty.getId()%></td>
                    <td><img src="viewallstudentsbyid.jsp?pid=<%=fty.getId()%>"></td>
                   	<td><%=fty.getFname()%></td>
                    <td><%=fty.getLname()%></td>                    
                    <td><%=fty.getDepartmnt()%></td>
                    <td><a href="adminviewstud.jsp?sid=<%=fty.getId()%>"><button>View</button></a></td>
                </tr>
